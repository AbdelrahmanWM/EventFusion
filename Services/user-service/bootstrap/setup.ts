...
public static async setup(){
    const storageService:DotenvStorageService = new DotenvStorageService();
    ...
    const passportJWTStrategy: PassportJWTStrategy = PassportJWTStrategy.getInstance(config,userService);
