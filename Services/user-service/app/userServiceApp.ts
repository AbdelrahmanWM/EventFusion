...
class UserServiceApp {
    ...
    private constructor(config: Config, passportJWTStrategy: PassportJWTStrategy,userRouter: UserRouter, authRouter: AuthRouter){
        this.app=express()
        this.config=config;
    ...
    public static getInstance(config: Config, passportJWTStrategy: PassportJWTStrategy, userRouter: UserRouter, authRouter: AuthRouter):UserServiceApp{
        if(!UserServiceApp.instance){
            UserServiceApp.instance= new UserServiceApp(config,passportJWTStrategy,userRouter,authRouter);
        }
